...
export function TaproomMarqueeCard({ status }: TaproomMarqueeCardProps) {
  const hasPulse = isImminentEvent(status);
  const addCalendar = calendarHref(status);

  return (
    <section className="relative overflow-hidden rounded-xl border border-[#c7b79e] bg-[rgba(255,252,246,0.88)] p-5">
